...
export default function Authenticate({ setAuthModelIsOpen, setEmail, setPassword, authenticate, setAuthOption }) {
     return (
          <div className='second-container' style={{ height: '470px' }}>
               ...
               <div className="content">
                    <span className='inter-semibold'>Welcome Back to Lunex</span>
                    ...
                    <div className="auth">
                         ...
                         <button className='submit-btn inter-regular' onClick={authenticate}>Authenticate</button>
